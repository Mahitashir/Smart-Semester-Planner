...
$semester_col_check = mysqli_query($conn, "SHOW COLUMNS FROM COURSE_COMPLETED LIKE 'completed_semester'");
if ($semester_col_check && mysqli_num_rows($semester_col_check) == 0) {
    mysqli_query($conn, "ALTER TABLE COURSE_COMPLETED ADD completed_semester VARCHAR(20) NULL AFTER gpa");
}
    ...
    <table>
        ...
        <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <tr>
                ...
                <?php if (!empty($row['gpa'])): // Course IS completed ?>
                ...
                <?php else: // Course is NOT completed ?>
